...
NOTE: ONTAP 9.8 のリリースでは、 MetroCluster のアップグレードおよび拡張手順はに移動しました link:../upgrade/index.html["MetroCluster のアップグレードと拡張"] および link:../transition/index.html["MetroCluster FC から MetroCluster IP に移行します"]。
