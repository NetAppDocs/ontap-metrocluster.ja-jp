...
. ISL 暗号化を有効にする場合は、で該当するタスクを実行します link:https://docs.netapp.com/us-en/ontap-metrocluster/install-fc/index.html["『 Fabric-attached MetroCluster Installation and Configuration Guide 』"]。
+
