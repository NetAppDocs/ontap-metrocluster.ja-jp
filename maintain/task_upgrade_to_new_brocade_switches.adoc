...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Brocade のG620 へのアップグレード完了後]
...
----
+
image::../media/brocade_upgr_to_g620_fab_1_down.gif[Brocade をファブリック 1 がダウンした状態で G622 にアップグレード]
...
.. 新しいスイッチをラックに設置します。
+
image::../media/brocade_upgr_to_g620_replaced_a_1.gif[Brocade をA1 に置き換えて G622 にアップグレード]
...
+
image::../media/brocade_upgr_to_g620_replaced_b_1.gif[Brocade をB1 に置き換えて G622 にアップグレード]
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Brocade G620 スイッチの交換とアップグレードの完了後のMetroClusterのワークフロー]
