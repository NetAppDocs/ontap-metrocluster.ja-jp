...
image::../media/consolidating_stacks_before.gif[FibreBridge交換前のスタック統合]
...
+
image::../media/consolidating_stacks_1st_7500n_in_place.gif[最初のFibreBridge 7500Nを設置してスタックを統合]
...
** この時点では、FibreBridge 7600N または 7500N ブリッジ FC1 ポートを接続しないでください。image:../media/consolidating_stacks_2nd_7500n_in_place.gif["2台目のFibreBridge 7500Nを設置してスタックを統合"]
...
+
image::../media/consolidating_stacks_sas_top_before.gif[FibreBridge 7500N にケーブル接続する前に SAS スタックを統合する]
...
+
image::../media/consolidating_stacks_sas_top_after.gif[統合後のSASトップケーブル配線]
...
+
image::../media/consolidating_stacks_sas_bottom_before.gif[下段の棚に統合する前のグリーン SAS ケーブル]
...
+
image::../media/consolidating_stacks_sas_bottom_after.gif[統合後のSAS下部ケーブル配線]
...
+
image::../media/consolidation_sas_bottom_connection_4_stacks.gif[4スタック用のSAS下部ケーブル]
...
image::../media/zoning_consolidation_site_a_before.gif[FibreBridgeの変更前のサイトAでのゾーニング統合]
...
image::../media/zoning_consolidation_site_a_after.gif[FibreBridgeの変更後のサイトAでのゾーニング統合]
...
+
image::../media/consolidating_stacks_sas_ports_recabled.gif[FC_switch_A_2 への統合後の FC2 ポートのケーブル接続]

. 下段のブリッジの FC1 ポートを FC_switch_A_1 の正しいポートにケーブル接続します。
+
image::../media/consolidating_stacks_final.gif[最終スタック統合配線]
