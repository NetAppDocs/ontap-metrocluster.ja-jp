...
* MetroCluster IP構成では、の手順に従いますlink:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_sw_config_verify_haconfig.html["コントローラモジュールのシステムデフォルトの復元"]。
