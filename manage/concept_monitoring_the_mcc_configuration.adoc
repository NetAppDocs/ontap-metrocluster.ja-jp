...
* link:../tiebreaker/index.html["MetroCluster Tiebreaker ソフトウェアをインストールして設定します。"]
* link:../install-ip/concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html["自動計画外スイッチオーバーのための ONTAP メディエーターサービスを設定します"]
