...
summary: MetroCluster 構成にはさまざまなハードウェアコンポーネントが必要です。わかりやすいように、 MetroCluster のドキュメント全般をとおして標準的なコンポーネント名を使用します。また、一方のサイトをサイト A と呼び、もう一方のサイトをサイト B と呼びます 
---
...
[role="lead"]
MetroCluster 構成にはさまざまなハードウェアコンポーネントが必要です。わかりやすいように、 MetroCluster のドキュメント全般をとおして標準的なコンポーネント名を使用します。また、一方のサイトをサイト A と呼び、もう一方のサイトをサイト B と呼びます
