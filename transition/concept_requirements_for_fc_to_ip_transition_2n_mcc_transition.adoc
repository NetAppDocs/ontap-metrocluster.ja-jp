...
+
image::../media/transition_2n_4_new_ip_nodes_on_the_shelves.png[既存のシェルフに4つの新しいIPノードを導入して移行]
...
image::../media/workflow_2n_transition_bsaic.png[2ノード移行のワークフロー]
...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["MetroCluster 構成を削除しています"]
