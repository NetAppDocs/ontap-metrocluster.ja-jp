...
メディエーター
 a| 
link:../install-ip/concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html#configuring-the-ontap-mediator-service-from-a-metrocluster-ip-configuration["MetroCluster IP 構成での ONTAP メディエーターサービスの設定"]
