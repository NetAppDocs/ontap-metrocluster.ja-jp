...
+
特定された LIF は、の手順 1 に移動する必要があります xref:concept_requirements_for_fc_to_ip_transition_2n_mcc_transition.adoc[MetroCluster FC ノードから MetroCluster IP ノードへのポートのマッピング]。
