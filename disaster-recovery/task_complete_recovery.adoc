...
* FabricPool 構成の詳細については、を参照してください link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["ディスクとアグリゲートパワーガイド"]。


.ステップ
. の手順「 Replacing a FabricPool mirror on a MetroCluster configuration 」に従います link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["ディスクとアグリゲートパワーガイド"]。
