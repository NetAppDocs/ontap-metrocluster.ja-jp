...
ONTAP 9.0 以前を実行している構成の場合は、を参照してください link:install-fc/concept_port_assignments_for_fc_switches_when_using_ontap_9_0.html["ONTAP 9.0 を使用している場合の FC スイッチのポート割り当て"]。
