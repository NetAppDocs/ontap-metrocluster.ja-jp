...
ゾーニングの変更や FibreBridge 6500 から FibreBridge 7500 へのアップグレードの実行には、 _ MetroCluster メンテナンスガイド _ から手順 _ ホットスワップ a FibreBridge 6500N ブリッジと FibreBridge 7500N / 7600N ブリッジ _ を使用できます。
