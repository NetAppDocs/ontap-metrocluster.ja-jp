...
2 entries were displayed.
----
. MetroCluster オペレーションのステータスを確認します
+
「 MetroCluster operation show 」を参照してください
...
+
次の例に示すように、影響を受けるアグリゲートの RAID ステータスが「 normal 」になります。
