...
NOTE: ミラーされた単一のデータアグリゲートを使用する場合は、を参照してください link:concept_configure_the_mcc_software_in_ontap.adocSTEP_429E7F7532ED4B468B67B9B22968D686["「 ONTAP での MetroCluster ソフトウェアの設定」の手順 1"] 手順については、を参照し
