...
.手順
. 各コントローラの FC-VI ポートと HBA ポートを代替 FC スイッチのポートにケーブル接続します。
+
|===
...
.2+| コンポーネント .2+| ポート 2+| Brocade スイッチモデル 6505 、 6510 、 6520 、 7810 、 7840 、 G610 、 G620 、 G620 -1 、 G630 、 G630-1 、 および DCX 8510-8 | 2 + Brocade スイッチ G720 
