...
+
link:upgrade-mcc-ip-system-controller-replace-apply-rcf-set-bootarg.html#set-the-metrocluster-ip-bootarg-variables["MetroCluster の bootarg IP 変数を設定します"]の手順を使用します。
