...
+
** 次の表に、サポートされるプラットフォームモデルの組み合わせを示します。
...
[NOTE]
====
* BES-53248 IP スイッチを使用している場合、 AFF A320 プラットフォームモデルはアップグレードに対応していません。
...
====
image::../media/supported_controller_upgrades_mccip_sosb.png[サポートされているコントローラアップグレードはmccip ssobです]
