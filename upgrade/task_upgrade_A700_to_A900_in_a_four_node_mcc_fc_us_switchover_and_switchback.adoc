...
. 次の手順を使用します。 link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations["MetroCluster 構成を追加しています"] _MetroCluster Tiebreaker のインストールと構成_ セクション。
