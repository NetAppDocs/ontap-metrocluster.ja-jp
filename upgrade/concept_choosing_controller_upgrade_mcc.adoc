...
image::../media/metrocluster_ip_upgrade_table_yellowdogdp1.PNG[MetroCluster IPアップグレードテーブルyellowdogdp1]
...
image::../media/metrocluster_fc_upgrade_table_yellowdogp1.PNG[MetroCluster fcアップグレードテーブルyellowdogp1]
