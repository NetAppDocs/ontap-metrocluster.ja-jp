...
Tiebreaker
 a| 
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb["MetroCluster 構成を追加しています"] _MetroCluster Tiebreaker のインストールと構成_ を参照してください。
