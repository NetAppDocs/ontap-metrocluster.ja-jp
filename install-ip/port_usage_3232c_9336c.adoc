...
プラットフォームポート割り当てを確認し、AFF A20システムをCisco 3232Cまたは9336Cスイッチにケーブル接続します。image:../media/mcc-ip-cabling-aff-a20-9161.png["は、Cisco 3232CまたはCisco 9336Cプラットフォームのポート割り当てを示しています。"]
...
image:../media/mcc-ip-cabling-a90-fas90-c80-fas70-a70-a1k-cisco-3232C-or-9336c-switch.png["は、Cisco 3232CまたはCisco 9336Cプラットフォームのポート割り当てを示しています。"]
