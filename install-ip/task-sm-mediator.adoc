...
NOTE: CLIを使用してHTTPSを使用するONTAP Mediatorのみを設定できます。System Managerはサポートされていません。詳細については、link:concept_mediator_requirements.html#select-a-communication-protocol-for-ontap-mediator["ONTAP Mediatorの通信プロトコルを選択してください"]を参照してください。
