...
link:concept_mediator_requirements.html["自動計画外スイッチオーバーのための ONTAP メディエーターサービスを設定します"]
...
link:concept_considerations_differences.html["ONTAP メディエーターまたは MetroCluster Tiebreaker を使用する場合の考慮事項"]
