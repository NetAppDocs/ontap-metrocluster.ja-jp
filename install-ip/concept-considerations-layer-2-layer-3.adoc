...
image::../media/MCC_layer2.png[MetroClusterレイヤー 2 ネットワーク構成]
...
image::../media/mcc_layer3_backend.png[MetroClusterレイヤー 3 バックエンド ネットワーク構成]
...
image::../media/switch_traffic_with_cisco_switches.png[MetroClusterトラフィックにNetApp認定のCiscoスイッチを使用する場合に必要な設定]

次の図は、外部スイッチがBroadcom IPスイッチの場合の共有ネットワークに必要な設定の概要を示しています。

image::../media/switch_traffic_with_broadcom_switches.png[Broadcom IPスイッチを使用する場合の共有ネットワークに必要な設定]
